...
import com.bkl.examine.utils.FrontUtil;
...
public class ExamineConfig {
	...
	private static void flush() {
		//add by jackmao
		mediaBaseUrl=Config.getString("config.media.baseurl");
		fileSavePath=Config.getString("config.file.save.path");
		webroot=Config.getString("config.webroot");
	...
	public static void setRengouPoolSize(double rengouPoolSize) {
		ExamineConfig.rengouPoolSize = rengouPoolSize;
	}
	...
	*/
	...
	public static void main(String[] args) {
		System.out.println(FrontUtil.formatDouble(ExamineConfig.getDefaultCoinExtraRate()));
	}
}
